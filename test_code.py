...
def image_filter_function(path='/media/xiaolong/datapool/data/downloads/丝袜美女/'):
...
def cut_video(video_audio_path_name='/media/xiaolong/datapool/data/youtube_video/sex.mp4'):
    if 1:
        #video_audio_path_name=video_result_path_name.replace('.','_audio.')
        cut_video_name=video_audio_path_name.replace('.mp4','_s_v.mp4')
        print('get fine')
        #import IPython
        #IPython.embed()
        string_time="ffmpeg -v quiet -y -i "+video_audio_path_name+ " -vcodec copy -acodec copy -ss 00:09:09 -t 00:00:50 -sn "+cut_video_name
